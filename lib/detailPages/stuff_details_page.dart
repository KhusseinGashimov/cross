    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: StreamBuilder<DocumentSnapshot>(
          stream: FirebaseFirestore.instance.collection('stuffs').doc(docId).snapshots(),
          builder: (context, snapshot) {
            ...
            var stuffData = snapshot.data!;
            return Text(stuffData['name'], style: const TextStyle(color: Colors.white));
          },
        ),
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => StuffEditScreen(documentId: docId),
                ),
              );
            },
          ),
